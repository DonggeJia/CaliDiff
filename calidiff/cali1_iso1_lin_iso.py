...
def train_epoch(
    ...
    device: torch.device,
    log_every: int = 50,
    curve_path: str = "train_loss_curve2_local_lin_iso.png",
):
    model.train()
    total_loss = 0.0
    n_batches = 0
...
def plot_all_losses(
    ...
    val_losses,
    pde_losses,
    out_path: str = "loss_curves_all_lin_iso.png",
):
    """
...
def main():
    root_dir = "/data/IMcali/sim_results_2025-12-17 22:31:04_lin_iso"  # TODO: set your dataset path
    img_size = 128
    patch_size = 2
    batch_size = 16
    num_epochs = 100
    ...
    np.savez(
        "loss_histories_all_local_lin_iso.npz",
